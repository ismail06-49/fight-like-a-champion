    ...
    <div className='bg-stone-400'>
      ...
      >
        <nav className="flex items-center justify-between mx-10 px-10 py-10">
          <Image className='w-auto' src={Logo} alt='Logo' width={74} height={74} />
        ...
        <h1 className='text-white font-bold text-8xl mx-10 mt-14 p-10'>FIGHT LIKE <br/><span className='text-red-700'>A CHAMPION</span></h1>
      </header>
      <section id='about' className='h-[550px] mx-10 px-10 flex'>
        <div className="w-full flex flex-row justify-between items-center">
          <Image className='h-auto' src={AboutImg} alt='about image' width={530} height={375} />
          <div className='w-1/3 h-[375px] flex flex-col justify-between'>
            <h2 className='text-stone-900 font-bold text-6xl pl-6 border-l-16 border-solid border-red-600'>ABOUT US</h2>
            <p className='text-stone-800 text-2xl'>Lorem ipsum dolor sit amet consectetur adipisicing elit. Veniam voluptates unde. Quas repudiandae delectus enim ratione, similique dolorem laborum vel dolorum molestiae necessitatibus, illum officia eius fuga quod provident suscipit magni quam.</p>
